...
using MailCheck.Insights.Entity.Seeding.DomainCreated;
...
namespace MailCheck.Insights.Entity
{
    public static class LocalEntryPoint
    {
        public static void Main(string[] args)
        {
            ...
            {
                CommandOption dmarcConnectionString = command.Option("-d", "User Database Connection String", CommandOptionType.SingleValue);
