    ...
    public class StartUp
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                ...
                .AddSingleton<IInsightsService, InsightsService>()
                .AddSingleton<IInsightsResponseModelFactory, InsightsResponseModelFactory>()
                .AddSingleton<IInsightsDao, InsightsDao>()
                .AddSingleton<IDatabase, DefaultDatabase<MySqlProvider>>()
                .AddSingleton<IInsightsSummaryResponseModelFactory, InsightsSummaryResponseModelFactory>()
                .AddSingleton<IInsightsApiConfig, InsightsApiConfig>()
                .AddTransient<IMessagePublisher, SnsMessagePublisher>()
                .AddTransient<IAmazonSimpleNotificationService, AmazonSimpleNotificationServiceClient>()
                .AddAudit("Insights-Api")
